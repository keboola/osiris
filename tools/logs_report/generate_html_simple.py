#!/usr/bin/env python3
"""Simple HTML generator that builds the HTML in parts to avoid string literal issues."""
...
<head>
    ...
    <script>
        ...
        const sessionDetails = __SESSION_DETAILS__;
    </script>
</head>
<body>
    <div class="container">
    ...
    html = html.replace("__EMBEDDED_DATA__", data_json)
    html = html.replace("__SESSION_DETAILS__", json.dumps(session_details))
